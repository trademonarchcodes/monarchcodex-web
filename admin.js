...
async function checkAdmin(){
 ...
 const adminEmails=["infocryptox2025@gmail.com","ezebolaprinceokechukwu@gmail.com","admin@monarch-codex.pages.dev"];
 const isAdminByEmail = adminEmails.includes((profile?.email||user.email||"").toLowerCase());
