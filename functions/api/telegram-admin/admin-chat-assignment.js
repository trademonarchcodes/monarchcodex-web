...
async function forward(context) {
  ...
  const target = new URL("/telegram/admin-chat-assignment", "https://telegram-internal.invalid");
  ...
  return fetch(TELEGRAM_WORKER_URL + "/telegram/admin-chat-assignment", {method:"POST", headers, body});
}
